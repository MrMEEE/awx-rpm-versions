...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-python-daemon build,devel,dist,static-analysis,test
...
%pyproject_buildrequires -x build,devel,dist,static-analysis,test
