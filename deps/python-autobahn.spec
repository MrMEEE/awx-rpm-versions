...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-autobahn all,compress,dev,encryption,nvx,scram,serialization,twisted,ui,xbr
...
%pyproject_buildrequires -x all,compress,dev,encryption,nvx,scram,serialization,twisted,ui,xbr
