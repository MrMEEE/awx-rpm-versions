...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-python-jose cryptography,pycrypto,pycryptodome,test
...
%pyproject_buildrequires -x cryptography,pycrypto,pycryptodome,test
