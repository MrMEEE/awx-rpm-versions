...
BuildRequires: python3.11-certifi = 2024.7.4
...
BuildRequires: python3.11-django-ansible-base = 20240701
BuildRequires: python3.11-django-ansible-base+jwt_consumer = 20240701
BuildRequires: python3.11-django-ansible-base+rest_filters = 20240701
...
BuildRequires: python3.11-dm-xmlsec-binding = 3.0
...
BuildRequires: python3.11-importlib-resources = 6.4.0
...
BuildRequires: python3.11-mypy = 1.10.1
...
BuildRequires: python3.11-swagger-spec-validator = 3.0.4
...
BuildRequires: python3.11-trove-classifiers = 2024.7.2
BuildRequires: python3.11-twilio = 8.13.0
BuildRequires: python3.11-twine = 5.1.1
...
BuildRequires: python3.11-types-setuptools = 70.1.0.20240627
...
Requires: python3.11-certifi = 2024.7.4
...
Requires: python3.11-django-ansible-base = 20240701
Requires: python3.11-django-ansible-base+jwt_consumer = 20240701
Requires: python3.11-django-ansible-base+rest_filters = 20240701
...
Requires: python3.11-dm-xmlsec-binding = 3.0
...
Requires: python3.11-importlib-resources = 6.4.0
...
Requires: python3.11-mypy = 1.10.1
...
Requires: python3.11-swagger-spec-validator = 3.0.4
...
Requires: python3.11-trove-classifiers = 2024.7.2
Requires: python3.11-twilio = 8.13.0
Requires: python3.11-twine = 5.1.1
...
Requires: python3.11-types-setuptools = 70.1.0.20240627
...
ln -s /opt/awx-rpm/public/static/awx $RPM_BUILD_ROOT/usr/lib/python%{python3_pkgversion}/site-packages/awx/ui/public
...
%changelog
* Mon Mar 10 2025 01:49:24 AM CET +0100 Martin Juhl <m@rtinjuhl.dk> 24.6.1
