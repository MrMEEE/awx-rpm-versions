...
BuildRequires: python3-django-filter = 23.5
...
BuildRequires: python3-drf-spectacular = 0.26.5
...
BuildRequires: python3-setuptools-scm = 8.0.4
BuildRequires: python3-setuptools-scm+toml = 8.0.4
...
BuildRequires: python3-types-setuptools = 69.0.0.20240106
BuildRequires: python3-typing-extensions = 4.4.0
BuildRequires: python3-uritemplate = 4.1.1
...
Requires: python3-django-filter = 23.5
...
Requires: python3-drf-spectacular = 0.26.5
...
Requires: python3-hatchling = 1.21.0
...
Requires: python3-setuptools-scm = 8.0.4
Requires: python3-setuptools-scm+toml = 8.0.4
