...
BuildRequires: python3.11-blinker = 1.8.1
...
BuildRequires: python3.11-freezegun = 1.5.0
...
BuildRequires: python3.11-pytest = 8.2.0
...
BuildRequires: python3.11-rapidfuzz = 3.8.1
...
BuildRequires: python3.11-trove-classifiers = 2024.4.10
...
BuildRequires: python3.11-types-psutil = 5.9.5.20240423
BuildRequires: python3.11-types-setuptools = 69.5.0.20240423
...
BuildRequires: python3.11-uwsgi = 2.0.25.1
...
BuildRequires: python3.11-virtualenv = 20.26.1
...
Requires: python3.11-blinker = 1.8.1
...
Requires: python3.11-freezegun = 1.5.0
...
Requires: python3.11-pytest = 8.2.0
...
Requires: python3.11-rapidfuzz = 3.8.1
...
Requires: python3.11-trove-classifiers = 2024.4.10
...
%changelog
* Sat May 04 2024 02:20:39 AM CEST +0200 Martin Juhl <m@rtinjuhl.dk> 24.3.1
