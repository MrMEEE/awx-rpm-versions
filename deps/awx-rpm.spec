...
Requires: python3.11-configobj = 5.0.9
...
Requires: python3.11-django-ansible-base = 2025.3.7
Requires: python3.11-django-ansible-base+authentication = 2025.3.7
Requires: python3.11-django-ansible-base+channel-auth = 2025.3.7
...
Requires: python3.11-django-redis = 5.4.0
Requires: python3.11-django-redis+hiredis = 5.4.0
...
Requires: python3.11-dynaconf = 3.2.10
Requires: python3.11-dynaconf+configobj = 3.2.10
Requires: python3.11-dynaconf+ini = 3.2.10
Requires: python3.11-dynaconf+redis = 3.2.10
Requires: python3.11-dynaconf+toml = 3.2.10
Requires: python3.11-dynaconf+vault = 3.2.10
Requires: python3.11-dynaconf+yaml = 3.2.10
Requires: python3.11-ecdsa = 0.19.0
...
Requires: python3.11-hvac = 2.3.0
Requires: python3.11-hvac+parser = 2.3.0
...
Requires: python3.11-python3-openid+postgresql = 3.2.0
...
Requires: python3.11-python-jose = 3.4.0
...
Requires: python3.11-redis+hiredis = 5.2.1
Requires: python3.11-redis+ocsp = 5.2.1
...
Requires: python3.11-ruamel-yaml = 0.18.10
Requires: python3.11-ruamel-yaml-clib = 0.2.12
Requires: python3.11-ruamel-yaml+jinja2 = 0.18.10
Requires: python3.11-ruamel-yaml-jinja2 = 0.2.7
...
Requires: python3.11-social-auth-app-django = 5.4.1
Requires: python3.11-social-auth-core = 4.4.1
Requires: python3.11-social-auth-core+all = 4.4.1
Requires: python3.11-social-auth-core+allpy3 = 4.4.1
Requires: python3.11-social-auth-core+azuread = 4.4.1
Requires: python3.11-social-auth-core+openidconnect = 4.4.1
Requires: python3.11-social-auth-core+saml = 4.4.1
Requires: python3.11-sqlparse = 0.5.3
Requires: python3.11-tabulate = 0.9.0
Requires: python3.11-tabulate+widechars = 0.9.0
Requires: python3.11-tacacs-plus = 2.6
Requires: python3.11-tempora = 5.8.0
Requires: python3.11-toml = 0.10.2
...
%changelog
* Tue Mar 11 2025 12:08:19 AM CET +0100 Martin Juhl <m@rtinjuhl.dk> 30.0.0
