...
BuildRequires: python3-gitpython = 3.1.30
BuildRequires: python3-google-auth = 2.14.1
BuildRequires: python3-hatch-fancy-pypi-readme = 23.1.0
BuildRequires: python3-hatchling = 1.18.0
...
BuildRequires: python3-keyring = 24.2.0
...
BuildRequires: python3-maturin = 1.2.3
...
BuildRequires: python3-platformdirs = 3.10.0
BuildRequires: python3-priority = 1.3.0
BuildRequires: python3-prometheus-client = 0.17.1
...
BuildRequires: python3-setuptools-scm = 7.1.0
BuildRequires: python3-setuptools-scm+toml = 7.1.0
BuildRequires: python3-setuptools-twine = 0.1.3
BuildRequires: python3-shellingham = 1.5.3
...
BuildRequires: python3-trove-classifiers = 2023.9.19
...
BuildRequires: python3-types-setuptools = 68.2.0.0
...
Requires: python3-gitpython = 3.1.30
Requires: python3-google-auth = 2.14.1
Requires: python3-hatch-fancy-pypi-readme = 23.1.0
Requires: python3-hatchling = 1.18.0
...
Requires: python3-keyring = 24.2.0
...
Requires: python3-maturin = 1.2.3
...
Requires: python3-platformdirs = 3.10.0
Requires: python3-priority = 1.3.0
Requires: python3-prometheus-client = 0.17.1
...
Requires: python3-setuptools-scm = 7.1.0
Requires: python3-setuptools-scm+toml = 7.1.0
Requires: python3-setuptools-twine = 0.1.3
Requires: python3-shellingham = 1.5.3
