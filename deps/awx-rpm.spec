...
BuildRequires: python3-asgiref+tests = 3.6.0
...
BuildRequires: python3-cachecontrol = 0.13.1
BuildRequires: python3-cachecontrol+filecache = 0.13.1
...
BuildRequires: python3-cryptography = 41.0.3
...
BuildRequires: python3-django-ansible-base = 20240109
...
BuildRequires: python3-django-debug-toolbar = 4.2.0
...
BuildRequires: python3-djangorestframework-yaml+dev = 2.0.0
BuildRequires: python3-djangorestframework-yaml+docs = 2.0.0
BuildRequires: python3-djangorestframework-yaml+tests = 2.0.0
...
BuildRequires: python3-gitpython = 3.1.32
BuildRequires: python3-google-auth = 2.14.1
BuildRequires: python3-hatch-fancy-pypi-readme = 24.1.0
BuildRequires: python3-hatch-fancy-pypi-readme+dev = 24.1.0
BuildRequires: python3-hatch-fancy-pypi-readme+tests = 24.1.0
...
BuildRequires: python3-jinja2+i18n = 3.1.2
...
BuildRequires: python3-markdown+testing = 3.4.1
...
BuildRequires: python3-prometheus-client+twisted = 0.19.0
...
BuildRequires: python3-python-daemon+devel = 3.0.1
BuildRequires: python3-python-daemon+test = 3.0.1
...
BuildRequires: python3-sqlparse+dev = 0.4.4
BuildRequires: python3-sqlparse+doc = 0.4.4
BuildRequires: python3-sqlparse+test = 0.4.4
BuildRequires: python3-tacacs-plus = 1.0
BuildRequires: python3-tempora = 5.1.0
BuildRequires: python3-tomli = 2.0.1
BuildRequires: python3-trove-classifiers = 2024.1.31
...
BuildRequires: python3-types-setuptools = 69.0.0.20240125
...
Requires: python3-asgiref+tests = 3.6.0
...
Requires: python3-build = 1.0.3
Requires: python3-cachecontrol = 0.13.1
Requires: python3-cachecontrol+filecache = 0.13.1
...
Requires: python3-cryptography = 41.0.3
...
Requires: python3-django-ansible-base = 20240109
...
Requires: python3-django-debug-toolbar = 4.2.0
...
Requires: python3-djangorestframework-yaml+dev = 2.0.0
Requires: python3-djangorestframework-yaml+docs = 2.0.0
Requires: python3-djangorestframework-yaml+tests = 2.0.0
...
Requires: python3-gitpython = 3.1.32
Requires: python3-google-auth = 2.14.1
Requires: python3-hatch-fancy-pypi-readme = 24.1.0
Requires: python3-hatch-fancy-pypi-readme+dev = 24.1.0
Requires: python3-hatch-fancy-pypi-readme+tests = 24.1.0
...
Requires: python3-jinja2+i18n = 3.1.2
...
Requires: python3-markdown+testing = 3.4.1
...
Requires: python3-prometheus-client+twisted = 0.19.0
...
Requires: python3-python-daemon+devel = 3.0.1
Requires: python3-python-daemon+test = 3.0.1
