...
mv $RPM_BUILD_ROOT/usr/bin/ansible-runner $RPM_BUILD_ROOT/usr/bin/ansible-runner%{python3_pkgversion}
%endif
...
%if "%{python3_pkgversion}" != "3"
sed -i "s|/usr/bin/ansible-runner|/usr/bin/ansible-runner%{python3_pkgversion}|g" %{pyproject_files}
%endif
