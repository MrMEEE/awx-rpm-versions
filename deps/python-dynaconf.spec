...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-dynaconf configobj,ini,redis,toml,vault,yaml
...
%pyproject_buildrequires -x configobj,ini,redis,toml,vault,yaml
