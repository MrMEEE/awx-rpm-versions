...
%pyproject_extras_subpkg -n python3-attrs dev,docs,tests,tests-no-zope,tests_no_zope
...
%pyproject_buildrequires -x dev,docs,tests,tests-no-zope,tests_no_zope
