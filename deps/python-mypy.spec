...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-mypy dmypy,faster-cache,install-types,mypyc,reports
...
%pyproject_buildrequires -x dmypy,faster-cache,install-types,mypyc,reports
