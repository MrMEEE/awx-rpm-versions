...
%package -n     python3-azure-keyvault-certificates
Summary:        %{summary}

%description -n python3-azure-keyvault-certificates %_description
...
%files -n python3-azure-keyvault-certificates -f %{pyproject_files}
