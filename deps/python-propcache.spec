...
%package -n     python%{python3_pkgversion}-propcache
Summary:        %{summary}

%description -n python%{python3_pkgversion}-propcache %_description
...
%files -n python%{python3_pkgversion}-propcache -f %{pyproject_files}
