...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-attrs cov,dev,docs,tests,tests-mypy,tests-no-zope
...
%pyproject_buildrequires -x cov,dev,docs,tests,tests-mypy,tests-no-zope
