...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-attrs benchmark,cov,dev,docs,tests,tests-mypy
...
%pyproject_buildrequires -x benchmark,cov,dev,docs,tests,tests-mypy
