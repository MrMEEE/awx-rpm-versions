...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-keyring check,completion,cover,doc,enabler,test,type
...
%pyproject_buildrequires -x check,completion,cover,doc,enabler,test,type
