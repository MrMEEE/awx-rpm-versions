...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-google-auth aiohttp,enterprise-cert,pyjwt,pyopenssl,reauth,requests
...
%pyproject_buildrequires -x aiohttp,enterprise-cert,pyjwt,pyopenssl,reauth,requests
