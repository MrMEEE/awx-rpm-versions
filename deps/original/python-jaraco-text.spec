...
Source:         %{pypi_source jaraco_text}
...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-jaraco-text doc,inflect,test


%prep
%autosetup -p1 -n jaraco_text-%{version}


%generate_buildrequires
# Keep only those extras which you actually want to package or use during tests
%pyproject_buildrequires -x doc,inflect,test
