...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-scikit-build-core cov,dev,docs,test,test-hatchling,test-meta,test-numpy,test-schema,wheel-free-setuptools,wheels
...
%pyproject_buildrequires -x cov,dev,docs,test,test-hatchling,test-meta,test-numpy,test-schema,wheel-free-setuptools,wheels
