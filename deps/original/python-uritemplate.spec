...
%package -n     python3-uritemplate
Summary:        %{summary}

%description -n python3-uritemplate %_description
...
%files -n python3-uritemplate -f %{pyproject_files}


%changelog
* Mon Jan 08 2024 Martin Juhl <m@rtinjuhl.dk> - 4.1.1-1
- Initial package