...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-dulwich dev,fastimport,https,paramiko,pgp
...
%pyproject_buildrequires -x dev,fastimport,https,paramiko,pgp
