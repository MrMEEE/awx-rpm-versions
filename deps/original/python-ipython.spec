...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-ipython all,black,doc,kernel,matplotlib,nbconvert,nbformat,notebook,parallel,qtconsole,test,test-extra
...
%pyproject_buildrequires -x all,black,doc,kernel,matplotlib,nbconvert,nbformat,notebook,parallel,qtconsole,test,test-extra
