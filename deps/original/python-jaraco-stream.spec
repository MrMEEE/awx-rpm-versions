...
Source:         %{pypi_source jaraco_stream}
...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-jaraco-stream check,cover,doc,enabler,test,type


%prep
%autosetup -p1 -n jaraco_stream-%{version}
