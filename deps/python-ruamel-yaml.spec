...
Source:         %{pypi_source ruamel.yaml}
...
This is package 'ruamel-yaml' generated automatically by pyp2spec.}
...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-ruamel-yaml docs,jinja2
...
%pyproject_buildrequires -x docs,jinja2
