...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-scikit-build-core wheel-free-setuptools,wheels
...
%pyproject_buildrequires -x wheel-free-setuptools,wheels
